...
device = torch.device("cuda" if torch.cuda.is_available() else "cpu")#cuda means compute unified device architecture
sum_model.to(device)
...
# Utility functions for quiz generation (similar as before)
